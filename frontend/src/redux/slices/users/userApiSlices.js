...
// The usersApiSlice is where will be making request to our API. We will be using this slice in our components to make requests to our API, logging in, registering and updating the user.
